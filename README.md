...
1. [Вступ](#Вступ)
2. [Змінні](#Змінні)
   - [Використовуйте значущі та вимовні імена змінних](#Використовуйте-значущі-та-вимовні-імена-змінних)
   ...
   - [Використовуйте імена, які зручно шукати (частина 1)](#Використовуйте-імена-які-зручно-шукати-частина-1)
   - [Використовуйте імена, які зручно шукати (частина 2)](#Використовуйте-імена-які-зручно-шукати-частина-2)
   ...
   - [Не додавайте зайвий контекст](#Не-додавайте-зайвий-контекст)
...
3. [Порівняння](#Порівняння)
   - [Використовуйте тотожнє порівняння](#Використовуйте-тотожнє-порівняння)
   - [Оператор поєднання з null](#Оператор-поєднання-з-null)
4. [Функції](#Функції)
   - [Аргументи функцій (краще два або менше)](#Аргументи-функцій-краще-два-або-менше)
   - [Імена функцій повинні бути такими, що говорять](#Імена-функцій-повинні-бути-такими-що-говорять)
   - [Функції мають бути на одному рівні абстракції](#Функції-мають-бути-на-одному-рівні-абстракції)
...
5. [Об'єкти та структури даних](#Обєкти-та-структури-даних)
   ...
   - [Об'єкти повинні мати `private`/`protected` компоненти](#Обєкти-повинні-мати-privateprotected-компоненти)
6. [Класи](#Класи)
   - [Композиція краща за успадкування](#Композиція-краща-за-успадкування)
...
7. [SOLID](#solid)
   ...
   - [Принцип підстановки Барбари Лісков (Liskov Substitution Principle, LSP)](#Принцип-підстановки-Барбари-Лисків-liskov-substitution-principle-lsp)
   - [Принцип поділу інтерфейсу (Interface Segregation Principle, ISP)](#Принцип-поділу-інтерфейсу-interface-segregation-principle-isp)
...
### Використовуйте однакові назви для змінних зі схожим призначенням
...
### Уникайте ментального співставлення
...
### Функції мають бути на одному рівні абстракції
...
Прапорці кажуть вашим користувачам, що функції роблять більше однієї речі. А вони мають робити щось одне. Розділяйте свої функції, якщо вони йдуть різними гілками коду відповідно до булевої логіки.
...
### Уникайте флуентного інтерфейсу (`Fluent interface`)
...
- [O: Принцип відкритості/закритості (Open/Closed Principle, OCP)](#Принцип-відкритостізакритості-openclosed-principle-ocp)
- [L: Принцип підстановки Барбари Лисків (Liskov Substitution Principle, LSP)](#Принцип-підстановки-Барбари-Лисків-liskov-substitution-principle-lsp)
...
### Принцип підстановки Барбари Лисків (Liskov Substitution Principle, LSP)
